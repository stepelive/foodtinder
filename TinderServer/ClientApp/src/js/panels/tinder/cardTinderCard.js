  ...
  return (
    <div>
      ...
      <div className='buttons'>
        {canSwipe &&
          <Div className='buttons'>
            <Icon28CancelCircleFillRed width={44} height={44} onClick={() => swipe('left')}></Icon28CancelCircleFillRed>
            <Icon28LikeCircleFillRed width={44} height={44} onClick={() => swipe('right')}></Icon28LikeCircleFillRed>
          </Div>}
      </div>
